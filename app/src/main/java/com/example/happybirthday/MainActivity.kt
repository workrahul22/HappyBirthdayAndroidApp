        ...
        setContent {
            HappyBirthdayTheme {
                ...
                Surface(
                    ...
                    GreetingImage(message = getString(R.string.happy_birthday_sam), from = getString(
                                            R.string.from_rahul))
                }
            }
        }
...
fun GreetingPreview() {
    HappyBirthdayTheme {
        GreetingImage(message = stringResource(id = R.string.happy_birthday_sam), from = stringResource(
            id = R.string.from_rahul
        ))
    }
}